...
def parse_arguments():
    ...
    parser.add_argument('--context-size', default=3, type=int, help='Number of previously translated pages to give the translator as context, for more consistent/coherent translations across a session. 0 disables.')

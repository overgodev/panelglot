...
class ConfigGPT:
    ...
    _CHAT_SAMPLE = {
        ...
        'Thai': [
            ...
            (
                "<|1|>อายจัง... ไม่อยากเด่น... อยากหายไปเลย...\n"
                "<|2|>เธอ... ไม่เป็นไรใช่ไหม⁉\n"
                "<|3|>ไอ้นี่มันอ่านสถานการณ์ไม่ออกหรือไง...?"
            )
        ]
    }
    ...
    _JSON_SAMPLE = {
        ...
        'Thai': [
            ...
            TranslationList(
                TextList=[
                    TextValue(ID=1,text="อายจัง... ไม่อยากเด่น... อยากหายไปเลย..."),
                    TextValue(ID=2,text="เธอ... ไม่เป็นไรใช่ไหม⁉"),
                    TextValue(ID=3,text="ไอ้นี่มันอ่านสถานการณ์ไม่ออกหรือไง...?")
                ]
            )
        ]
    }
